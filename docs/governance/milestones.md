...
| M4 - certified tessellation floor | IN_PROGRESS | Every valid or conservatively repairable face produces a deterministic boundary-exact intersection-free triangle mesh | Exact planar CDT supports direct holes; the no-weld assembler certifies a planar box, an open perforated face product, and the first closed curved body. The 64-by-1 full cylinder has 128 shared vertices and 252 triangles across its registered wall and CDT caps with complete analytic chord/normal evidence. General curved surfaces, axial interior provenance/refinement, adaptive patch bounds, critical regions, 3D triangle intersections, production routing, Linux determinism, and corpus completion remain open. |
| M5 - non-vacuous validation | IN_PROGRESS | All required validator coverage is non-zero/complete; twisted-wall and vacuous-provenance witnesses fail before their fixes | Trim, CDT, endpoint normalization, cylinder registration/error bounds, and certified body certificates report expected/checked/skipped/failed. Count mismatch, extra axial samples, chord/normal excess, and vacuous face coverage refuse by name. Remaining independent source-incidence/Euler, general curved face bounds, triangle/triangle, historical twisted-wall, and deliberately vacuous provenance gates remain open. |
| M6 - planar and cylinder templates | IN_PROGRESS | Box, full/partial cylinder, mismatched-frame cylinder, and connected plane/cylinder fixtures pass end to end | The first full capped-cylinder certified floor passes with registered equal-count rims and safe-floor modelling alias. Partial cylinders, interior axial rings, independently certified modelling quads/caps, mismatched-reference and connected plane/cylinder fixtures, and workflow routing remain open. |
