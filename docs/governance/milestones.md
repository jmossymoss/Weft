...
| M3 - predicates, counts, canonical boundaries | IN_PROGRESS | Every valid shared edge has one bijective sample sequence and consistent coedge UV uses | Exact bounded equality/minimum/parity count assignment and analytic circle demands pass strict and static-analysis property tests; see `docs/evidence/m3-interval-solver-2026-07-17.md`. Sum constraints, exact predicates, periodic lifting/registration, and canonical sampling remain open. |
