...
| BR-010 | Recipe v2 per-entity/manual application | Source references and fingerprints now persist, but the certified templates do not yet consume per-face, per-edge, or manual edit constraints | Certified template consumer, source-surface validator, deterministic replay fixture, and complete application certificate | ENFORCED |
